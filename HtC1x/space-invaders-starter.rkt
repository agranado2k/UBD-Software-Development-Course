...
(check-expect (next-game G2)
              (make-game (list (make-invader (+ 150 INVADER-X-SPEED) (+ 100 INVADER-Y-SPEED) 12)) ;; for what I'll use dx?
                         (list (make-missile 150 (- 300 MISSILE-SPEED)))
                         (make-tank (+ 50 TANK-SPEED) 1)))
(check-expect (next-game G3)
              (make-game (list (make-invader (+ 150 INVADER-X-SPEED) (+ HEIGHT INVADER-Y-SPEED) -10))
                         (list (make-missile 150 (- 300 MISSILE-SPEED)))
                         (make-tank (+ 50 TANK-SPEED) 1)))
...
;; Game -> Game
;; update positions for invaders, missile, and tank
(check-expect (next-game G0)
              (make-game empty empty (make-tank (+ (/ WIDTH 2) TANK-SPEED) 1)))
(check-expect (next-game G1)
              (make-game empty empty (make-tank (- (/ WIDTH 2) TANK-SPEED) -1)))
(check-expect (next-game G2)
              (make-game (list (make-invader (+ 150 INVADER-X-SPEED) (+ 100 INVADER-Y-SPEED) 12)) ;; for what I'll use dx?
                         (list (make-missile 150 (- 300 MISSILE-SPEED)))
                         (make-tank (+ 50 TANK-SPEED) 1)))
(check-expect (next-game G4)
              (make-game (list (make-invader (+ 150 INVADER-X-SPEED) (+ 100 INVADER-Y-SPEED) 12) I2) (list M1 M4) T1)
